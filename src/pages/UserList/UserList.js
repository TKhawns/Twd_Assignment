...
function UserList() {
    ...
    const currentTableData = useMemo(() => {
        ...
        if (sort) {
            ...
            const fullNameA = `${a.login.username} ${a.name.title} ${a.name.first} ${a.name.last}`.toLowerCase();
            const fullNameB = `${b.login.username} ${b.name.title} ${b.name.first} ${b.name.last} `.toLowerCase();
                            ...
                            <div className="section">
                                <div className="filter">
                                    ...
                                    <div className="col1">
                                        ...
                                        <div className="col1">
                                            <select id="sort" className="form-select" type="text" onChange={handleSort}  >
                                    ...
                                    <div className="top-content">
                                                ...
                                                return (
                                                    <div className="body-row" key={index}>
                                                        ...
                                                        <div className="body-row-data2">
                                                            <a target="blank"  >{item.picture.medium.toString()}</a>
                                                        </div>
                                                        <div
                                                            className="body-button"
                                                        >
                                                            <a className="infor-link" href="/details" role="button">
                                                                Detail
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="pagination-container">
                                            <Pagination
                                                ...
                                                totalCount={list.results === null ? 0: list.results.length}
                                                pageSize={PageSize}
