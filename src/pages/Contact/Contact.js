                ...
                <div className="contact-content">
                    ...
                    <div className="contact-body">
                        ...
                        <div className="information">
                            <p className="header-info">Trinh Van Khanh</p>
                            <div className="header-data">
                                ...
                                <div className="script">Địa chỉ: E3, 144 Xuân Thủy, Cầu Giấy, Hà Nội</div>
                            </div>
                            <div className="header-data">
                                <div className="icon">
                                    <svg
                                ...
                                <div className="script">Điện thoại: 038.2588.919</div>
                            </div>
                            <div className="header-data">
                                <div className="icon">
                                    <svg
                                ...
                                <div className="script">Email: 21020343@vnu.edu.vn</div>
                            </div>
                        </div>
                    </div>
                </div>
